...
from utils import spectrogram_from_file as spectrogram_from_file
...
inputs = spectrogram_from_file(audio_filename, step=10, window=20, max_freq=8000, eps=1e-14)
...
targets = np.asarray([SPACE_INDEX if x == SPACE_TOKEN else COLLON_INDEX if x == COLLON_TOKEN else  ord(x) - FIRST_INDEX
                      for x in targets])
